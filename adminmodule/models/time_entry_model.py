...
class TimeEntry(TimeStampedModel):
    ...
    def __str__(self):
        """ return string in the response of the object."""
    ...
    def total_work_time(self):
        ...
        breaks_duration = sum([break_entry.duration_in_seconds() for break_entry in self.breaks.all()])
