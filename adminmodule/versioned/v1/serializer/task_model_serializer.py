...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employees
        fields = ['id', 'employee_id', 'profile_pic','user']

class TaskEmployeeSerializerTemp(serializers.ModelSerializer):
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = [
            'id', 'department', 'priority', 'title', 'task_image', 'description', 'assigned_to', 'assigned_to_ids',
    ...
    def get_assigned_to(self, obj):
        ...
        return TaskEmployeeSerializerTemp(task_employees, many=True).data
